...
Este repositório tem como objetivo documentar o meu percurso de aprendizagem na área da cibersegurança, reunindo conteúdos teóricos, exercícios práticos, ferramentas exploradas, comandos utilizados, análises realizadas e reflexões técnicas.

Pretende também demonstrar a evolução das minhas competências e servir como base de consulta para estudo futuro, desenvolvimento profissional e preparação para novos projetos na área.
